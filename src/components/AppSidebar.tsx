                  ...
                  <SidebarMenuItem key={module.title}>
                    ...
                    >
                      ...
                      <div className="relative flex-shrink-0">
                        <Avatar className="w-10 h-10 ring-2 ring-transparent group-hover:ring-opacity-50 transition-all duration-300"
                          style={{ 
                  ...
                  <SidebarMenuButton className="h-auto p-0">
                    <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-sidebar-hover transition-all duration-300 w-full text-left group">
                      ...
                      {!isCollapsed && <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-sidebar-foreground opacity-60 font-light">
                            {chat.timestamp}
                          </div>
                        </div>}
                    </div>
